...
def save_singlefile(output_dir, varname, in_suffix, out_suffix = '_concatTime'):
    file_names = sorted(glob.glob(output_dir + '*' + in_suffix))
    da_list = []
    for f in file_names:
...
if __name__ == '__main__':
    ...
    save_singlefile(output_dir, varname, file_suffix)    
