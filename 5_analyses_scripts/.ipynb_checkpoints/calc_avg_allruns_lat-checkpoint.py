...
if __name__ == '__main__':
    ...
    ##############################################
    wrf_hydro_dir_list = ['/g/data/w28/ad9701/WRF-Hydro/SEA/runs_wCalibPars_4km/wrf_hydro_nwm_public-5.2.0_domain4_4km_12g_defSoil_defPar/trunk/NDHMS/Run/',
    ...
    out_dir = '/g/data/w28/ad9701/WRF-Hydro/SEA/runs_wCalibPars_4km/concat_results_lat/'
